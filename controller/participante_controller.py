...
def registrar_participante(username: str) -> Tuple[Optional[Participante], str]:
    ...
    participante, mensagem = participante_repository.criar_participante(novo_participante)
    if not participante:
        return None, mensagem
    return participante, f"Participante {participante.get_username()} criado com sucesso! A senha provisória é: {senha_crua}"
