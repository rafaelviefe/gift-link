...
from views import (
    ...
    tela_participante_view,
    tela_cadastro_participante_view,
    tela_alterar_senha_view
)
    ...
    while True:
        ...
        if janela_ativa == janela_inicial:
            if evento == "-CADASTRO-":
                ...
                janela_inicial.hide()
                janela_login = tela_login_view.criar_janela_login()
                ...
                if valores['-ORGANIZADOR-']:
                    ...
                    if participante:
                        if not participante.is_elegivel():
                            ...
                            janela_alterar_senha = tela_alterar_senha_view.criar_janela_alterar_senha(participante.get_username())
                            janela_login.hide()
                        else:
                            sg.popup_ok(mensagem)
                            ...
                            janela_login = None
                            janela_inicial.close()
                            janela_participante = tela_participante_view.criar_janela_participante(participante_logado)
                    else:
                        sg.popup_error(mensagem)
